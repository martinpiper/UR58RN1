...
_RO_DO_REPLICAOBJECT_INTERNAL_SETUPOPAQUEPOINTER(Plane,GameObject)
...
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMINDISTANCE(300.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMAXERROR(100.5f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMAXDISTANCE(10000.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETQUADRATIC()
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETSNAPTODIFFERENCE(100.0f)
...
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMINDISTANCE(500.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMAXERROR(5.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMAXDISTANCE(5000.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETQUADRATIC()
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETSNAPTODIFFERENCE(1.1f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETDELTASHORTFLOAT()
_RO_DO_REGISTERBLOCK_END()
...
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMAXDISTANCE(5000.0f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETQUADRATIC()
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETSNAPTODIFFERENCE(1.5f)
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETDELTASHORTFLOAT()
_RO_DO_REGISTERBLOCK_END()
...
_RO_DO_REGISTERBLOCK_END()
_RO_DO_REGISTERBLOCK_NDATA_VAR(mID)
_RO_DO_REGISTERBLOCK_END()
